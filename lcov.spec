...
Source0  : https://github.com/linux-test-project/lcov/releases/download/v1.15/lcov-1.15.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609783572
...
cp %{_builddir}/lcov-1.15/COPYING %{buildroot}/usr/share/package-licenses/lcov/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
%make_install
